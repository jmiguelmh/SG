...
class Esfera extends THREE.Object3D {
  ...
  createGUI(gui,titleGui)
  {
    ...
    folder.add (this.guiControls, 'widthSegments', 3, 100, 1).name ('Segmentos ancho: ').onChange(function(value){that.crearNuevo()});
    folder.add (this.guiControls, 'heightSegments', 3, 100, 1).name ('Segmentos alto: ').onChange(function(value){that.crearNuevo()});
  }
